 ...
 * @Last Modified time: 2019-03-02 13:07:43
 */
 ...
 */
sellerSchema.methods.comparePassword = function(inputPassword, cb) {
  bcrypt.compare(inputPassword, this.password, function(err, isMatch) {
    if (err) return cb(err);
    cb(null, isMatch);
  });
};
sellerSchema.plugin(handleMongooseError);
exports.Seller = mongoose.seller.model('Seller', sellerSchema);
